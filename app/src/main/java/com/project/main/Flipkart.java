    ...
    protected ArrayList<Product> doInBackground(final String... strings) {
        try{
            ...
            if(a.equals("Mobiles & Accessories") ||a.equals("Home Entertainment")){
                ...
                calling.call(1,strings[0],"_3O0U0u","a","_3wU53n","_1vC4OE _2rQ-NK","_3auQ3N _2GcJzG","img","VGWI6T","_38sUEc","hGSR34");
                ...
                CallingGeneral calling = new CallingGeneral();
                calling.call(1,strings[0],"IIdQZO _1SSAGr","a","_2mylT6 _3Ockxk","_1vC4OE","_3auQ3N","img","VGWI6T","_38sUEc","hGSR34");
                products = calling.products;
                System.out.println("Flipkart ended");
                return products;
            }
                ...
                CallingGeneral calling = new CallingGeneral();
                calling.call(1,strings[0],"_3liAhj","a","_2cLu-l","_1vC4OE","_3auQ3N","img","VGWI6T","_38sUEc","hGSR34");
                products = calling.products;
                System.out.println("Flipkart ended");
                return products;
            }
