...
public class Groceries_category extends AppCompatActivity implements arraySave, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchbar.setAdapter(new ArrayAdapter<>(Groceries_category.this, android.R.layout.simple_list_item_1, suggestions));
        ...
        findViewById(R.id.notifications_toolbar_icon).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Groceries_category.this, Notifications.class));
            }
        });
        ...
        findViewById(R.id.wishlist_toolbar_icon).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Groceries_category.this, Wishlist.class));
            }
        });
        ...
        findViewById(R.id.category_toolbar_icon).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Groceries_category.this, searchActivity.class));
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.notifications){
            ...
            Intent intent = new Intent(Groceries_category.this, searchActivity.class);
            startActivity(intent);
        }
