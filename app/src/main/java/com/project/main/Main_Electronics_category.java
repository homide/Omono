...
public class Main_Electronics_category extends AppCompatActivity implements arraySave, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnSearch).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (searchtext.length() <= 0) {
                    Toast.makeText(Main_Electronics_category.this, "Please add something to search.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    do {
                        handler.postDelayed(new Runnable() {
                            public void run() {
                                pd.dismiss();
                                Intent intent = new Intent(Main_Electronics_category.this, Main2Activity.class);
        ...
        searchbar.setAdapter(new ArrayAdapter<>(Main_Electronics_category.this, android.R.layout.simple_list_item_1, suggestions));
        ...
        findViewById(R.id.notifications_toolbar_icon).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Main_Electronics_category.this, Notifications.class));
            }
        });
        ...
        findViewById(R.id.category_toolbar_icon).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Main_Electronics_category.this, SelectCategoryClass.class));
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.notifications){
            Intent cinemaIntent = new Intent(Main_Electronics_category.this, Notifications.class);
            ...
            Intent intent = new Intent(Main_Electronics_category.this, SelectCategoryClass.class);
            startActivity(intent);
        }
