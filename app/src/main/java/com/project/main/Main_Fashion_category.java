...
public class Main_Fashion_category extends AppCompatActivity implements arraySave, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.notifications_toolbar_icon).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Main_Fashion_category.this, Notifications.class));
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.notifications){
            Intent cinemaIntent = new Intent(Main_Fashion_category.this, Notifications.class);
            ...
            Intent intent = new Intent(Main_Fashion_category.this, SelectCategoryClass.class);
            startActivity(intent);
        }
